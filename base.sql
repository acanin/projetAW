...
;              
CREATE USER IF NOT EXISTS SA SALT '003717bc8afc9931' HASH '93d1c975a0ae35d4e32fd796de61bad92a5f54adbf12b72eac829d421ab6a1cf' ADMIN;            
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_915A19D2_CA9C_407B_AA12_C6E5114472D9 START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_852B5840_AE12_48E8_AA9C_A15585C34204 START WITH 12 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_7CCDFC9D_27E9_4EA7_8C97_EC086FAE8CAF START WITH 5 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_E4226522_BF1B_437A_84F8_2DC89422F953 START WITH 8 BELONGS_TO_TABLE;     
...
-- 5 +/- SELECT COUNT(*) FROM PUBLIC.DONNEUR;  
...
(6, 24, 2, TRUE, 4, TRUE, 6, 'Rogeri', 0, 59, 'Roger', FALSE, FALSE, 156, 2, NULL);            
...
-- 4 +/- SELECT COUNT(*) FROM PUBLIC.RECEVEUR; 
...
-- 10 +/- SELECT COUNT(*) FROM PUBLIC.UTILISATEUR;             
