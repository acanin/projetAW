...
;              
CREATE USER IF NOT EXISTS SA SALT '88e48307a8d7f3b3' HASH 'ef56bae4469d76e8ff5a4813663422e3ee4c4e6604224e214bbabf814fc577a1' ADMIN;            
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_C6DD8197_6091_46E7_90F5_56D71B1959A3 START WITH 6 BELONGS_TO_TABLE;     
...
-- 5 +/- SELECT COUNT(*) FROM PUBLIC.NOTIFICATION;             
...
-- 5 +/- SELECT COUNT(*) FROM PUBLIC.RDV;      
...
-- 19 +/- SELECT COUNT(*) FROM PUBLIC.UTILISATEUR;             
...
(12, 5, TRUE, 'P', 'mdp'),
(13, 6, TRUE, 'maiDDl', 'mdp'),
(14, 7, TRUE, 'mailSC', 'mdp'),
(15, 8, FALSE, 'mailQQ', 'mdp'),
(16, 8, TRUE, 'mYPSEUDO', 'mdp'),
(17, 9, FALSE, 'MOI', 'mdp'),
(18, 10, FALSE, 'PSEU', 'mdp'),
(19, 11, FALSE, 'mail', 'mdp');    
